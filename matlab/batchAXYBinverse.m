function [ Y_candidate ] = batchAXYBinverse(inMeanA, inMeanB, inSigA, inSigB)
...
MeanB = inv(inMeanA);
SigB = Ad(inMeanA)*inSigA*(Ad(inMeanA))';

MeanA = inv(inMeanB);
SigA = Ad(inMeanB)*inSigB*(Ad(inMeanB))';
...
for i = 1:1:8
    ...
    Y_candidate(:,:,i) = inv(X_candidate(:,:,i));
end
...
% plot(thetaA(25:75),'r');
% hold on
% plot(shiftThetaB(25:75,k),'b')
% figure(3)
% subplot(8,1,k)
% plot(dA(25:75),'r');
% hold on
% plot(shiftDB(25:75,k),'b')
% end
% 
% 
% 
