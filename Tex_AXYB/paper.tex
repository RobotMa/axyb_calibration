...
\caption{
The solved $X$ (in blue) and the actual $X$ (in red) for 5 trials of simulation with noise covariance 0.01 and shift 2.
}
\label{fig4}
\end{figure}
\end{center}
...
\caption{
The solved $Y$ (in blue) and the actual $Y$ (in red) for 5 trials of simulation with noise covariance 0.01 and shift 2.
}
\label{fig5}
\end{figure}
\end{center}
